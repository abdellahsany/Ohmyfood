...
`P3` `Ohmyfood` `OpenClassrooms` `Développeur d'application - JavaScript React` `RNCP Développeur Concepteur Logiciel` `BAC Spécialité Numérique et Sciences Informatiques (NSI)`
